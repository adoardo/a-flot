                        ...
                        <div class="suda-part">
                            ...
                            <div class="suda-table-block">
                                <table class="suda-table">
                                    ...
                                    <tr class="suda-tr">
                                        <td class="suda-td">
                                            <div class="suda-td__number">1</div>
                                            <!-- /.suda-td__number -->
                                        </td>
                                        <!-- /.suda-td -->
                                        <td class="suda-td">
                                        ...
                                        <!-- /.suda-td -->
                                        <td class="suda-td">
                                            <div @click="toggleModal('shipinfo')" class="vacancy__button red js-open-modal" data-modal="5"><img
                                        ...
                                        <td class="suda-td">
                                            <div class="vacancy__button red"><img src="assets/img/suda/delete.svg"
                                                                                  alt="">
                                                Удалить
                                            </div>
                                        </td>
                                    ...
                                    <tr class="suda-tr">
                                        <td class="suda-td">
                                            <div class="suda-td__number">2</div>
                                            <!-- /.suda-td__number -->
                                        </td>
                                        <!-- /.suda-td -->
                                        <td class="suda-td">
                                    ...
                                    <tr class="suda-tr">
                                        <td class="suda-td">
                                            <div class="suda-td__number">3</div>
                                            <!-- /.suda-td__number -->
                                        </td>
                                        <!-- /.suda-td -->
                                        <td class="suda-td">
                        ...
                        <div class="suda-part">
                            ...
                            <div class="suda-item">
                                ...
                                <div class="suda-item__text">
                                    ...
                                    а при неточностях, проведут изменения. В случае возниконвения вопросов пожалуйста <a
